...
namespace GearCamChat
{
	...
	public class WebCamCapture : System.Windows.Forms.UserControl
	{
		...
		private GearCamChat.WebcamEventArgs x = new GearCamChat.WebcamEventArgs();
		...
		// event delegate
		public delegate void WebCamEventHandler (object source, GearCamChat.WebcamEventArgs e);
